...
<!-- Mirrored from nouthemes.net/html/bready/homepage-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Sep 2024 21:55:57 GMT -->
              ...
              <div class="ps-cart__content">
                <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                  ...
                  <div class="ps-cart-item__content"><a class="ps-cart-item__title"
                      href="product-detail.html">Kingsman</a>
                    <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                  </div>
                </div>
                <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                  <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img
                      src="images/shopping-cart/2.png" alt="">
                  </div>
                  <div class="ps-cart-item__content"><a class="ps-cart-item__title"
                      href="product-detail.html">Joseph</a>
                    <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                  </div>
                </div>
                <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                  <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img
                      src="images/shopping-cart/3.png" alt="">
                  </div>
                  <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">Todd
                      Snyder</a>
                    <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                  </div>
                </div>
      ...
      <div class="item">
        <div class="ps-banner--2">
          <div class="ps-banner__content">
            <div class="row">
              <div class="col-lg-6 col-md-5 col-sm-12 col-xs-12 d-flex justify-content-end f-text-right ">
                <div class="ps-banner__container">
                  <h5 class="animated" data-animation-in="zoomIn" data-delay-in="0.1">EVERY DAY WE MAKE</h5>
                  <h3 class="animated" data-animation-in="zoomIn" data-delay-in="0.3">Freshly baked Bread</h3>
                  <p class="animated" data-animation-in="zoomIn" data-delay-in="0.4">Bakery. See more. Do more.</p><a
                    class="ps-btn animated" href="#" data-animation-in="fadeInRight" data-delay-in="0.5">Order now</a>
                </div>
              </div>
              <div class="col-lg-6 col-md-7 col-sm-12 col-xs-12 ">
                <img src="images/cakes/1.png" style="width:350px; height:auto" alt="">
              </div>
            </div>
          </div>
        </div>
...
<!-- Mirrored from nouthemes.net/html/bready/homepage-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Sep 2024 21:56:54 GMT -->
